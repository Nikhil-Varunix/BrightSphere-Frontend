...
function layout_sidebar_change(value) {
  if (value == 'dark') {
    ...
    if (document.querySelector('#OrgLogo')) {
      document.querySelector('#OrgLogo').setAttribute('src', '/assets/images/logo.png');
    }
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.landing-logo')) {
      document.querySelector('.landing-logo').setAttribute('src', 'assets/images/logo.html');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/assets/images/logo.png');
    }
