      ...
      <div className="container py-4">
        <div className="card p-4">
          ...
          <div className="row mb-4">
              ...
              <div className="card shadow-sm p-3 mb-4">
                ...
                <div className="d-flex align-items-start">
                  ...
                  <div>
                    ...
                    <p className="mb-0 text-muted">Assigned On: {formatDate(assignedTo.assignedDate)}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="card shadow-sm p-3 mb-4">
                <h4 className="mb-3">Cancelled By</h4>
                <div className="d-flex align-items-start">
                  <img
                  ...
                  <div>
                    ...
                    <p className="mb-0"><i className="ti ti-phone me-2"></i> {customerDetails.phone}</p>
                    <p className="mb-0"><i className="ti ti-mail me-2"></i> {customerDetails.email}</p>
                    <p className="mb-0"><i className="ti ti-map-pin me-2"></i> Address: {customerDetails.primaryContact}</p>
                  </div>
                </div>
              </div>
            </div>
